...
namespace CSharpToTypeScript.Test
{
    ...
    public class TestCheckFileContainsScript : IDisposable
    {
        ...
        public void TestPersonPlusAddressAndUiHintsWithForm()
        {
            ...
            var testMethod2 = Utilities.GetTestDataFileContents("CSharpToTypeScript.TestNamespace.TestMethod1");

            var testMethod1Path = Path.Combine(Utilities.GetProjectFolder(), @"TestData\src\CSharpToTypeScript.TestNamespace.TestMethod2.ts");
